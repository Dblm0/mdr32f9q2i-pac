...
pub type PVU_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR_SPEC, bool, O>;
#[doc = "Field `RVU` reader - "]
pub type RVU_R = crate::BitReader<bool>;
#[doc = "Field `RVU` writer - "]
pub type RVU_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pvu(&mut self) -> PVU_W<0> {
        PVU_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn rvu(&mut self) -> RVU_W<1> {
        RVU_W::new(self)
    }
