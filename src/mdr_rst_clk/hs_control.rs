...
pub type HSE_ON_R = crate::BitReader<bool>;
#[doc = "Field `HSE_ON` writer - "]
pub type HSE_ON_W<'a, const O: u8> = crate::BitWriter<'a, u32, HS_CONTROL_SPEC, bool, O>;
#[doc = "Field `HSE_BYP` reader - "]
pub type HSE_BYP_R = crate::BitReader<bool>;
#[doc = "Field `HSE_BYP` writer - "]
pub type HSE_BYP_W<'a, const O: u8> = crate::BitWriter<'a, u32, HS_CONTROL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn hse_on(&self) -> HSE_ON_R {
        HSE_ON_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn hse_byp(&self) -> HSE_BYP_R {
        HSE_BYP_R::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    #[must_use]
    pub fn hse_on(&mut self) -> HSE_ON_W<0> {
        HSE_ON_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn hse_byp(&mut self) -> HSE_BYP_W<1> {
        HSE_BYP_W::new(self)
    }
