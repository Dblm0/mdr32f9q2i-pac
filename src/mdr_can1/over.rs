...
pub type ERROR_MAX_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ERROR_MAX` writer - "]
pub type ERROR_MAX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OVER_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn error_max(&mut self) -> ERROR_MAX_W<0> {
        ERROR_MAX_W::new(self)
    }
