...
pub type DB0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RXDATAL_SPEC, u8, u8, 8, O>;
#[doc = "Field `DB1` reader - "]
pub type DB1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DB1` writer - "]
pub type DB1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RXDATAL_SPEC, u8, u8, 8, O>;
#[doc = "Field `DB2` reader - "]
pub type DB2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DB2` writer - "]
pub type DB2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RXDATAL_SPEC, u8, u8, 8, O>;
#[doc = "Field `DB3` reader - "]
pub type DB3_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DB3` writer - "]
pub type DB3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RXDATAL_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
