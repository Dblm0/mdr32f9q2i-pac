...
pub type RXLS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RXLS` writer - "]
pub type RXLS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HRXCS_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn rxls(&self) -> RXLS_R {
        RXLS_R::new((self.bits & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1"]
